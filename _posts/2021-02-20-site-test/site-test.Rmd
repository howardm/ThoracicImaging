...
The <span class='BlueClass'>**blue border**</span> around the image indicates it's lightboxed.
...
```markup
Testing a markup entry of some kind
author:
  - name: Howard Mann
    url: http://howardmann.us
```
...
<div style="text-align:center;">
  <iframe class="pacsbin"
         ...
         <li><a class="pacsbin-link" href="#vali?s=1">Axial CT</a></li>
         </ul>
...
Let's try a panelset with three Tabs:
...
<p>
  ...
  <iframe class="pacsbin"
         ...
         <li><a class="pacsbin-link" href="#vali1?s=1">Axial CT</a></li>
         </ul>
